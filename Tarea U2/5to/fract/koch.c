...
int iniciaKoch(int n, double l, double x, double y, LOGO *tortuga) //inicializar
{
...
int dibujaKoch(void){   
  inicia(miX0Koch, miY0Koch, 0, ABAJO, tortugaAuxKoch); //funcion en logo

  return KochRecursivo(nivelRecursionKoch, longitudKoch, tortugaAuxKoch); //pinta
}
...
int KochRecursivo(int n, double l, LOGO *tortuga) //n recursividad, l longitud
{
  double l3;
  if (n<=0){
    avanza(l, tortuga);
